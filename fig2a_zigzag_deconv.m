...
IRFwin=58e-12;%
tIRF=(1:round(60e-12/dtInterp))*dtInterp-IRFwin/2;
fwhmIRF=23e-12;%24.7e-12; 
IRF=singleGauss(fwhmIRF/(2*(sqrt(2*log(2)))),0,tIRF,0);

lam=1;
Nit=10;
[deconvDat, cost] = deconvL1(ys(1:end),lam , IRF, 1,Nit );
figure;plot(deconvDat); yyaxis right; plot(ys)
% 
% 
