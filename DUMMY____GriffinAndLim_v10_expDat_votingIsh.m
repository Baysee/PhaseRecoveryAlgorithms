...
outputFigsDir='C:\Users\Lord Photon\Documents\MATLAB\time-frequency analysis\outputFigs_DUMMY_Cross_20221103\';
...
%                     save_figpng([outputFigsDir 'spgm_' itStr '_' timeNowStr]);
                    ...
                    if phaseAnalysis==2
                        ...
                        freqMovMeanFilt=smooth(abs(freqMovMean),winLen/8).';
                        ...
                        %    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% FOR PARAMETRIC ANALYSIS
                        allMaxFreqs(ifn, icl, inptWin, ibwIRF, iInter)=f(maxFreq);
