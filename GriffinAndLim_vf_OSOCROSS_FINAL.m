...
outputFigsDir='C:\Users\Lord Photon\Documents\MATLAB\time-frequency analysis\outputFigs_Cross_FINAL\';
        ...
        for inptWin=1:numel(nptPerWin_l)
            for ibwIRF=1:numel(bwIRF_l)
                for iInter=1:numel(interpAmounts)
                    ...
                    maxIteration=150; % Max number of iteration in GLA
                    % interpAmount_t=4 ; % For now, make this a power of 2 (or 1)!!
...
%                     saveas(f1,[outputFigsDir 'spgm_' itStr '_' timeNowStr '.png'],'png')
                    ...
                    SiOut_Raw=SiOut;
                        ...
                        mseFilt=sqrt(mean((freqMovMeanFilt-freqMovMean).^2));
                        ...
                        %    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% FOR PARAMETRIC ANALYSIS
                        allmseFilt( icl, ifn, inptWin, ibwIRF, iInter)=mseFilt;
...
%                     f1=gcf;
                    ...
                    if phaseAnalysis==2
                        ...
                        %    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% FOR PARAMETRIC ANALYSIS
                        allmseFiltVoted( icl, ifn, inptWin, ibwIRF, iInter)=mseFilt;
                        
                        timeNowStr=getTimeString();
                        save_figpng([outputFigsDir 'temporalTraceVoted_' itStr '_' timeNowStr]);
...
%                         saveas(f1,[outputFigsDir 'temporalTrace_' itStr '_' timeNowStr '.png'],'png')
        ...
        timeNowStr=getTimeString();
        save([outputFigsDir 'dataMatrix' timeNowStr],'allmseFiltVoted','allmseFilt','alldiCs','alldiRs')
        %
    end
    
    
    timeNowStr=getTimeString();
    save([outputFigsDir 'dataMatrixAll' timeNowStr],'allmseFilt','alldiCs','alldiRs')
    %
end
